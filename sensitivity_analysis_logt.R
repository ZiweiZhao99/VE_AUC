...
lambda.t <- function(t) 0.15*exp(beta+(beta0+beta1*log(t))*z)
...
# function to generate recurrent event times
lambda.t <- function(t) (0.1*(t<6)+0.2*(t>=6))*exp(beta+(beta0+beta1*log(t))*z)
lambda.i <- function(t) (0.1*(t<6)+0.2*(t>=6))*exp(beta+(beta0+beta1*log(t))) #hazard of intervention arm
...
# function to generate recurrent event times
lambda.t <- function(t) (0.2*(t<6)+0.1*(t>=6))*exp(beta+(beta0+beta1*log(t))*z)
lambda.i <- function(t) (0.2*(t<6)+0.1*(t>=6))*exp(beta+(beta0+beta1*log(t))) #hazard of intervention arm
...
save(List_logt, file = "./500 sensitivity logt.RData")
